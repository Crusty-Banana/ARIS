...
async function handler$DeleteBusinessType(db: Db, params: DeleteBusinessType$Params, collectionName: string) {
  const { id } = params;
...
export async function handler$DeleteUser(db: Db, params: DeleteBusinessType$Params) {
  return handler$DeleteBusinessType(db, params, BusisnessTypeCollection.users);
}

export async function handler$DeleteAllergen(db: Db, params: DeleteBusinessType$Params) {
...
export async function handler$DeleteSymptom(db: Db, params: DeleteBusinessType$Params) {
  return handler$DeleteBusinessType(db, params, BusisnessTypeCollection.symptoms);
}

export async function handler$DeleteRecommendation(db: Db, params: DeleteBusinessType$Params) {
  return handler$DeleteBusinessType(db, params, BusisnessTypeCollection.recommendations);
}