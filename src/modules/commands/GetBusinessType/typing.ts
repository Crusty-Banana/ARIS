...
export const LocalizedAllergen = Allergen.omit({
  name: true,
  description: true,
}).extend({
  name: z.string(),
...
export const LocalizedSymptom = Symptom.omit({
  name: true,
  description: true,
}).extend({
  name: z.string(),
...
export const GetAllergens$Params = GetBusinessType$Params.omit({
  filters: true,
}).extend({
...
export const GetSymptoms$Params = GetBusinessType$Params.omit({
  filters: true,
});
export type GetSymptoms$Params = z.infer<typeof GetSymptoms$Params>;

export const GetRecommendations$Params = GetBusinessType$Params.omit({
  filters: true,
});
export type GetRecommendations$Params = z.infer<
  typeof GetRecommendations$Params
>;

export const GetActionPlans$Params = GetBusinessType$Params.omit({
  filters: true,
});
...
export type GetRecommendations$Result = z.infer<
  typeof GetRecommendations$Result
>;
...
export type GetAllergensLocalized$Result = z.infer<
  typeof GetAllergensLocalized$Result
>;

export const GetSymptomsLocalized$Result = FetcherResult.extend({
  result: z.array(LocalizedSymptom).optional(),
});
export type GetSymptomsLocalized$Result = z.infer<
  typeof GetSymptomsLocalized$Result
>;

export const GetActionPlansLocalized$Result = FetcherResult.extend({
  result: z.array(LocalizedActionPlan).optional(),
});
export type GetActionPlansLocalized$Result = z.infer<
  typeof GetActionPlansLocalized$Result
>;
