...
export const PublicPAPSymptom =
  DisplayPAP.shape.allergens.element.shape.symptoms.element;

export type PublicPAPSymptom = z.infer<typeof PublicPAPSymptom>;

export const PublicPAPAllergen = DisplayPAP.shape.allergens.element
  .omit({
    symptoms: true,
    discoveryDate: true,
  })
