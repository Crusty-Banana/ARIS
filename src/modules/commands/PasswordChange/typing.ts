...
export const PasswordChangeWithUserIdSchema = User.pick({
  id: true,
  password: true,
}).extend({
  newPassword: z.string().min(6, "Password must be at least 6 characters"),
});
export type PasswordChangeWithUserIdSchema = z.infer<
  typeof PasswordChangeWithUserIdSchema
>;

export const PasswordChangeWithUserId$Params = PasswordChangeWithUserIdSchema;
export type PasswordChangeWithUserId$Params = z.infer<
  typeof PasswordChangeWithUserId$Params
>;
