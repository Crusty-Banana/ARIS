...
export type UpdateRecommendation$Params = z.infer<
  typeof UpdateRecommendation$Params
>;
...
export const UpdateAllergenFetcher$Params = UpdateAllergen$Params.omit({
  id: true,
});
export type UpdateAllergenFetcher$Params = z.infer<
  typeof UpdateAllergenFetcher$Params
>;
...
export const UpdateSymptomFetcher$Params = UpdateSymptom$Params.omit({
  id: true,
});
...
export const UpdateRecommendationFetcher$Params =
  UpdateRecommendation$Params.omit({ id: true });
export type UpdateRecommendationFetcher$Params = z.infer<
  typeof UpdateRecommendationFetcher$Params
>;
