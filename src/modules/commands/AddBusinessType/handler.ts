...
async function handler$AddBusinessType(db: Db, params: any, collectionName: string) {
...
export async function handler$AddUser(db: Db, params: AddUser$Params) {
  return await handler$AddBusinessType(db, params, BusisnessTypeCollection.users);
}
...
export async function handler$AddPAP(db: Db, params: AddPAP$Params) {
  return await handler$AddBusinessType(db, params, BusisnessTypeCollection.paps);
}

export async function handler$AddSymptom(db: Db, params: AddSymptom$Params) {
  return await handler$AddBusinessType(db, params, BusisnessTypeCollection.symptoms);
}

export async function handler$AddRecommendation(db: Db, params: AddRecommendation$Params) {
  return await handler$AddBusinessType(db, params, BusisnessTypeCollection.recommendations);
}